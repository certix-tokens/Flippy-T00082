...
<div className=' group flex flex-col items-center '>
      <div className='text-center mt-[184px] xl:mt-[50px] lg:mt-[100px] md:mt-[50px]'>
        <h1 className='font-jacks text-white font-normal text-5xl md:text-7xl xl:text-8xl transition-opacity duration-300 group-hover:opacity-0'>ABOUT US</h1>
      ...
      <div className='flex justify-center '>
        <motion.img
          src={Aboutus}
          alt=""
          className='absolute md:w-[448px] md:h-[448px] md:bottom-40 bottom-40 2xl:bottom-40  w-[300px] h-[300px] xl:h-[300px] xl:w-[300px] 2xl:h-auto 2xl:w-[400px] xl:bottom-0 group-hover:scale-110'
