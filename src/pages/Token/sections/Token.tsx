    ...
    <div className="relative h-[86.5vh] overflow-x-hidden overflow-y-hidden">
      ...
      >
        ...
        <div className="mx-auto grid w-full max-w-6xl grid-cols-3 place-items-center justify-center gap-6 py-8 sm:grid-cols-3 lg:grid-cols-3">
          ...
          <div className="group flex justify-center" onClick={() => toggleOpacity(0)}>
            <div className={`-h-30 top-[47%] left-2 absolute rounded-2xl bg-gradient-to-b from-[#4B181B] from-30% via-[#9B282F] to-[#B13940] px-10 py-10 text-center text-white md:opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:top-[40%] lg:top-[40%] lg:left-50 lg:text-[15px] sm:top-[42%] sm:left-15 xl:top-[40%] xl:left-40 xl:w-[260px] 2xl:top-[40%] 2xl:left-80 ${activeIndex === 0 ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="group group flex justify-center" onClick={() => toggleOpacity(1)}>
            <div className={`absolute h-30 top-[55%] rounded-2xl sm:top-[50%] bg-gradient-to-b from-[#4B181B] from-30% via-[#9B282F] to-[#B13940] px-10 py-10 text-center text-white md:opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:top-[47%] lg:top-[48%] xl:top-[43%] xl:w-[260px] 2xl:top-[40%] ${activeIndex === 1 ? 'opacity-100' : 'opacity-0'} `}>
              <p className="font-jel">0%</p>
          ...
          {/* right image  */}
          <div className="group flex justify-center" onClick={() => toggleOpacity(2)}>
            <div className={`absolute h-30 top-[47%] right-2 rounded-2xl sm:top-[43%] sm:right-15 bg-gradient-to-b from-[#4B181B] from-30% via-[#9B282F] to-[#B13940] px-10 py-10 text-center text-white md:opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 lg:right-45 lg:top-[42%] md:right-25 md:top-[40%] lg:text-[15px] xl:top-[40%] xl:right-40 xl:w-[260px] 2xl:top-[37%] 2xl:right-60 ${activeIndex === 2 ? 'opacity-100' : 'opacity-0'}  `}>
              <p className="font-jel">0%</p>
