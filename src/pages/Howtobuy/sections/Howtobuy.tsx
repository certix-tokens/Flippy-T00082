...
function HowToBuy() {
  return (
    ...
    >
      <div className="pt-[72px] md:pt-[65px] text-center">
        ...
        <div className="grid-col-2 md:grid-row-1 group grid">
          ...
          <div>
            <motion.img
              ...
              loading="lazy"
              className=" absolute top-70 md:top-60 2xl:group-hover:ml-40  sm:top-50 h-auto max-w-full group-hover:scale-90 2xl:-mt-10 xl:top-50 w-[280px]"
